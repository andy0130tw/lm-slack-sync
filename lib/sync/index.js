...
module.exports = {
  ...
  handlers: {
    status: function(req, resp) {
      resp.write('<h1>Status</h1>');
      resp.write('Last Sync = ' + lastSyncTime + '\n');
      resp.write('Current interval = ' + lastSetInterval + '\n');
      resp.write('Idle Tick = ' + idleTicks + '/' + idleThershold + '\n');
      resp.write('Post transferred = ' + transferredCount[0] + ' to LM + ' + transferredCount[1] + ' to Slack.\n');
      resp.end();
    }
  }
};
