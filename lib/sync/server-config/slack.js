...
var SLACK_CHANNEL = 'C04GS1ZLF';

// do NOT include bot_message since transferred post take 
//  advantage of this subtype!
var includedSubtype = ['me_message', 'file_share', 'file_comment'];
...
var slackConf = new ServerConfig({
  ...
  decode: function(resp) {
    ...
    resp.messages.forEach(function(v) {
      ...
      // exclude subtype
      if(subtype && includedSubtype.indexOf(subtype) < 0) return;
